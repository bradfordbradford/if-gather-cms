<?php
	...
	Class eventsave_inquiry_form extends SectionEvent{

		public $ROOTELEMENT = 'save-inquiry-form';
        ...
        <pre class="XML"><code>&lt;save-inquiry-form result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/save-inquiry-form></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;save-inquiry-form result="error">
...
&lt;/save-inquiry-form></code></pre>
  ...
  &lt;/label>
  &lt;label>Memo
    &lt;textarea name="fields[memo]" rows="15" cols="50">&lt;/textarea>
  &lt;/label>
  &lt;label>Responded To
    &lt;input name="fields[responded-to]" type="checkbox" value="yes" />
  &lt;/label>
  &lt;input name="action[save-inquiry-form]" type="submit" value="Submit" />
&lt;/form></code></pre>
        <p>To edit an existing entry, include the entry ID value of the entry in the form. This is best as a hidden field like so:</p>
        <pre class="XML"><code>&lt;input name="id" type="hidden" value="23" /></code></pre>
        <p>To redirect to a different location upon a successful save, include the redirect location in the form. This is best as a hidden field like so, where the value is the URL to redirect to:</p>
        <pre class="XML"><code>&lt;input name="redirect" type="hidden" value="http://sites.tc/Ensembles/Publishing-Platform/success/" /></code></pre>
...
send-email[recipient] // list of comma-separated author usernames.</code></pre>
  ...
  &lt;/form></code></pre>';
		...
		public function load(){
			if(isset($_POST['action']['save-inquiry-form'])) return $this->__trigger();
		}
