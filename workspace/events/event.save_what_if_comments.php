<?php
	...
	Class eventsave_what_if_comments extends SectionEvent{

		public $ROOTELEMENT = 'save-what-if-comments';
		...
		public static function about(){
			return array(
				'name' => 'Save What If Comments',
				'author' => array(
					'name' => 'Lindsey Bradford',
					'website' => 'http://ifgather-cms.tc',
					'email' => 'lindseyb@wearetelegraph.com'),
				'version' => 'Symphony 2.3.3',
				'release-date' => '2013-08-28T20:27:30+00:00',
				'trigger-condition' => 'action[save-what-if-comments]'
			);
		}
        ...
        <pre class="XML"><code>&lt;save-what-if-comments result="success" type="create | edit">
  &lt;message>Entry [created | edited] successfully.&lt;/message>
&lt;/save-what-if-comments></code></pre>
        <p>When an error occurs during saving, due to either missing or invalid fields, the following XML will be returned:</p>
        <pre class="XML"><code>&lt;save-what-if-comments result="error">
...
&lt;/save-what-if-comments></code></pre>
  ...
  &lt;/label>
  &lt;input name="action[save-what-if-comments]" type="submit" value="Submit" />
&lt;/form></code></pre>
        <p>To edit an existing entry, include the entry ID value of the entry in the form. This is best as a hidden field like so:</p>
        <pre class="XML"><code>&lt;input name="id" type="hidden" value="23" /></code></pre>
        <p>To redirect to a different location upon a successful save, include the redirect location in the form. This is best as a hidden field like so, where the value is the URL to redirect to:</p>
        <pre class="XML"><code>&lt;input name="redirect" type="hidden" value="http://ifgather-cms.tc/success/" /></code></pre>
...
send-email[recipient] // list of comma-separated author usernames.</code></pre>
  ...
  &lt;/form></code></pre>';
		...
		public function load(){
			if(isset($_POST['action']['save-what-if-comments'])) return $this->__trigger();
		}
